 ...
 * @param {string} type - Type of green space ('lawn', 'native-plants', 'mixed-woodland', etc.)
...
export function estimateCarbonOffset(areaInMeters, type = 'lawn') {
  ...
  // Based on research accounting for maintenance emissions
  const offsetFactors = {
    'lawn': 0.6, // Low due to mowing and maintenance emissions
    'native-plants': 2.0, // Good sequestration with lower maintenance
    'mixed-woodland': 4.5, // Managed woodland with mixed species
    'ornamental': 1.0, // Moderate due to higher maintenance
    'forest': 5.5, // Dense natural forest, best sequestration
    'meadow': 1.2 // Good balance of sequestration and low maintenance
  };
...
export function estimateTreeCount(areaInMeters, type = 'lawn') {
  // Trees per hectare by type (based on research for campus/urban environments)
  const treesDensity = {
    'lawn': 25, // Campus lawns with scattered mature trees
    'native-plants': 60, // Native plantings with mixed species
    'mixed-woodland': 250, // Managed woodland with mix of ages
    'ornamental': 40, // Ornamental gardens with feature trees
    'forest': 400, // Dense natural forest
    'meadow': 15 // Open meadow with scattered trees
  };
